-- Migration 036 : Extension des types de notification pour Epic 7
-- Ajoute CALENDRIER_OUTDATED, POST_REMPLACEMENT_NOTATION, NOTIFICATION_GROUPED
-- Préserve TOUTES les valeurs existantes (migrations 027 + 032)
